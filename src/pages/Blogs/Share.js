...
const Share = ({shareUrl, title, image}) => {
    return (
      <>
        <p className="text-uppercase">Share this page:</p>

        <div className="d-flex justify-content-center gap-3 align-items-center align-content-center">
