...
const BlogsDashboard = ({ fetchBlogs, loading, blogs,tags,dashboardTagsLoading, user,fetchLastWeekPostedBlogsCount,lastWeekPostedBlogsCount, publishersCount, fetchPublishersUsersCount, blogsCount, fetchBlogsCount, pendingBlogsCount, fetchPendingBlogsCount }) => {
  useEffect(() => {
  ...
  return (
    <>
      <Panel shaded>
        ...
        <Row gutter={30} >
          <Col xs={24} sm={24} md={24} lg={16} xl={16} data-aos="fade-down" data-aos-easing="ease-in-sine">
    ...
    <div className="value">
      {
        ...
        <Row gutter={20} className="dashboard-header">
          <Col md={24} xs={24} sm={24} lg={24} xl={24} data-aos="fade-down" data-aos-offset="50"
          data-aos-easing="ease-in-sine">
