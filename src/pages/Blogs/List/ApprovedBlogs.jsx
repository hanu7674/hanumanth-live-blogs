...
import { Form, Row, Col, FormGroup, ControlLabel, Button, Schema, IconButton, ButtonToolbar, Input, Drawer, SelectPicker, Stack, Divider, Uploader, Progress, Breadcrumb, Text, DatePicker, Checkbox, TagPicker, TagInput, Badge } from 'rsuite';
import PlusIcon from '@rsuite/icons/Plus';
import TrashIcon from '@rsuite/icons/Trash';
import { deleteBlog,  getApprovedBlogsList } from '../../../redux/blogs.js';
...
<IconButton circle size='sm' icon={<MdEdit className='rs-icon' />} onClick={() => handleEdit(rowData?.id)} />
...
const BlogsListPage = ({ getBlogs, blogsListLoading, blogsListData }) => {
  ...
  return (
    <Panel
      header={
        <>
          <h2 className="title">Approved Blogs Management</h2>
          <Breadcrumb>
            <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
            <Breadcrumb.Item>Admin</Breadcrumb.Item>
            <Breadcrumb.Item>Blogs</Breadcrumb.Item>
            <Breadcrumb.Item active>Approved Blogs Management</Breadcrumb.Item>
          </Breadcrumb>
        </>
      }
    >
...
const mapDispatchToProps = dispatch => ({
  getBlogs: () => dispatch(getApprovedBlogsList()),
});
const mapStateToProps = state => ({
  blogsListLoading: state.blogs?.loading,
  blogsListData: state.blogs?.approvedBlogs,
});
