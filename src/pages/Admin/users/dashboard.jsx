...
import { addFakeUserSignupLogs, fetchUserSignupLogs } from "../../../redux/dashboard";
import ApexRealtimeChart from "./RealTimeChart";
import { signuplogs } from "../tables/members/mock";

const UsersDashboard = ({ usersHeaderData, loading,fetchUserSignupLogs, userSignupLogs }) => {
